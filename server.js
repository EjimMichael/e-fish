...
let serviceAccount = require("./e-fish-dc4d6-firebase-adminsdk-7mvh7-69a7c3ca93.json");
...
const bucketName = "efish-website";
...
app.post("/add-product", (req, res) => {
  ...
  if (name.value.length) {
    ...
    return res.json({
      alert: "enter few tags to help in ranking your in search",
    });
  } else if (!tac) {
    return res.json({ alert: "you must agree to our terms and conditions" });
  }
